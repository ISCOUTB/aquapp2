...
@section('admin-content')
    ...
    @if (session('success-update'))
        <div class="alert alert-success alert-dismissible" role="alert">
            ...
            <strong> @lang(session('success-update'))</strong>
        </div>
    @endif
    ...
    <table class="table" id="table" data-show-toggle="true" data-paging="true" data-sorting="true" data-filtering="true"> <!--data-expand-first="true"-->
        ...
        <tr>
            ...
            <th>@lang('Name')</th>
            <th data-breakpoints="xs">@lang('Location')</th>
            <th data-breakpoints="xs sm md">@lang('Coordinates')</th>
            <th data-breakpoints="all">@lang('Status')</th>
